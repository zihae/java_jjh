...
public class ExEqualsEx1 {
	...
	public static void main(String[] args) {
		...
		if(a1.equals(a2)) {
			...
			System.out.println("두 객체의 멤버 면수값이 다릅니다.");
		}	
...
class ExbTestA{
	...
	public boolean equals(Object obj) {
		...
		//this : 내 객체 => 내 객체의 주소, obj는 비교 대상의 주고
		//주소가 같다는 건 같은 객체를 공유
		//비교 대상과 내가 같은 객체를 공유하는 경우
		if(this == obj) {
			return true;
		}
		//비교 대상이 내 클래스로 클래스 형변환이 가능해야함
		//비교 대상이 내 자식클래스의 객체이거나 나와 같은 클래스의 객체
		//멤버 변수를 비교하려면 상대방 멤버변수가 누가 있는지 알아야하기 때문에
