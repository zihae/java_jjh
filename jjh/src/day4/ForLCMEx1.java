...
public class ForLCMEx1 {
	...
	public static void main(String[] args) {
		 ...
		 *       10000과 20000인 경우 10000을 기준으로 10000씩 증가하면 2번이면 되지만 방법 1은 무조건 1씩 증가한다)
		 * 반복횟수 : i는 1부터 시작해서 num1 * num2까지 1씩 증가, 두 수의 최소공배수는 두 수의 곱보다 작거나 같다
		 * 규칙성: i가 num1의 배수이고 i가 num2의 배수이면 i를 출력하고 반복문을 종료
		 *       조건식: i % num1 == 0 && i % num2 == 0
		 * 실행문: i를 출력하고, 반복문 종료
		 */
		
		/* i: 어떤 정수
		 * a의 배수: i % a == 0
		 * 4의 배수: i % 4 == 0, 6의 배수: i % 6 == 0
		 * 공배수: i % 4 == 0 && i % 6 == 0
		 * 최소 공배수
		 * */
