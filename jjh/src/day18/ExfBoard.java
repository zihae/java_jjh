...
public class ExfBoard {
	...
	//초기화 => 생성자
	public ExfBoard(String title, String contents, String wirter) {
		this.title = title;
		this.contents = contents;
		this.writer = writer;
		this.date = new Date();
	...
	//게시글 등록할 때 사용되는 게시글이 아닌, 임시로 쓸 게시글이 필요한 경우 사용하려고 만든 기본생성자
	public ExfBoard() {} //임시로 만드는 게시글을 위해 count와 상관없이 쓸 수 있음
