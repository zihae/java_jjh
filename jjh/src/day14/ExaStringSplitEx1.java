...
public class ExaStringSplitEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 정규 표현식은 나중에 살펴볼 예정
		 * - 정규 표현식(Regular Expression)은 문자열에 패턴이 있는지 확인하는 식
		 * 
		 * String trim()
		 * - 문자열 첫글자가 오기 전까지 공백을 제거, 마지막 글자 이후에 오는 공백을 제거
		 * */
		 ...
		 *  -문자열 시작부분이 prefix로 시작하는지 알려주는 메소드로 prefix로 시작하면 true, 아니면 false
		 */
