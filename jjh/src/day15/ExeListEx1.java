...
public class ExeListEx1 {
	...
	public static void main(String[] args) {
		...
		//size()는 저장된 개수를 알려주는 기능
		System.out.println("리스트에 저장된 개수:" + list1.size());
		//remove(Object obj) : obj와 일치하는 객체를 제거한 후 제거한 객체를 알려 줌
		//remove(int index): index 번지에 있는 객체를 제거한 후 제거한 객체를 알려 줌
		//remove(1)을 하면 1과 일치하는 객체를 제거하는게 아니라 1번지에 있는 객체를 제거
		...
		//indexOf: 리스트에 객체와 일치하는 객체가 있으면 번지를 알려주고 없으면 -1을 알려주는 기능
