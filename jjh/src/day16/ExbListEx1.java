...
public class ExbListEx1 {
	...
	public static void main(String[] args) {
		...
		/* 학생 정보를 입력받고, 계속할건지를 물어봐서 y라고 대답하면 계속하고 아니면 종료하는 코드 */
		char next = 'y';
	...
	public static ExbStudent inputStudent(Scanner scan) {
		...
		/* nextLine()을 이용하는 경우 앞에서 Scanner를 통해 입력받은 값 중 엔터가 사라지지 않은 상황이면
		 * 실제 사용하려는 nextLine() 앞에 nextLine()을 한 번 더 입력해야한다. 앞에서nextLin() 사용했을 경우에는 
		 * nextLine()한 번 더 입력할 필요 없음
		 */
		scan.nextLine();
