...
public class MethodSumEX2 {
	...
	public static void main(String[] args) {
		...
		sumAll1(); //sumAll1은 1부터 10까지 합이 고정이기 떄문에 5부터 10까지 합을 구할 수 없다. 재사용성이 떨어짐
		sumAll2(10); //sumAll2는 sumAll1보다는 낫다. 1에서 5까지의 합을 구할 수 있다. 5에서 10까지의 합은 구할 수 없다.
		sumAll3(1,10); //5에서 10도 가능. 1에서 10까지의 합과 21에서 30까지의 합을 더한 값을 구할 때 사용할 수 없다.
		int begin = 5, end =10;
