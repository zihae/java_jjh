  ...
  <ul class="box-tabs">
  	<li id="idBox">
  		...
  		<div class="form-group">
			  <input type="text" class="form-control" placeholder="email" name="me_email">
			</div>
			<div class="form-group">
			  <input type="text" class="form-control" placeholder="name" name="me_name">
			</div>
  	...
  	<h1>비밀번호 찾기</h1>
  		<div class="form-group">
			...
			<div class="form-group">
			  <input type="text" class="form-control" placeholder="id" name="me_id">
			</div>
